...
export function computeAERI(input: AERIInput): number {
  ...
  return Math.round(aeri * 100) / 100;
}

export function aeriLabel(score: number): { label: string; color: string } {
